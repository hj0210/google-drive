            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="videoprocesses"
                        to="/videoProcessings/videoprocesses"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="notifyprocesses"
                        to="/notifications/notifyprocesses"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'videoprocesses', 
                route: '/videoProcessings/videoprocesses',
                ImageUrl: '',
            },
            { 
                title: 'Notifyprocess', 
                description: '', 
                key: 'notifyprocesses', 
                route: '/notifications/notifyprocesses',
                ImageUrl: '',
            },
