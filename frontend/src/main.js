...
pluralCaseList.push( {plural: "drives/uploadSystems", pascal: "DriveUploadSystem"} )

pluralCaseList.push( {plural: "indexers/indexprocesses", pascal: "IndexerIndexprocess"} )

pluralCaseList.push( {plural: "videoProcessings/videoprocesses", pascal: "VideoProcessingVideoprocess"} )

pluralCaseList.push( {plural: "notifications/notifyprocesses", pascal: "NotificationNotifyprocess"} )
